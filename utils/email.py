...
def register_vendor(user, to_email):
    ...
    message1 = 'Hello {} {}! \nYou are trying to sign up as a vendor with this email: \n{}\n'.format(
        user.first_name, user.last_name, user.email)
    message2 = 'Business name: \n{}\n Kindly open this link to continue '+ path +'/vendors/set-password/{}'.format(
        user.business_name, user.id
    )
    message = message1 + message2
    # from_email = 'noreply@foodvend.com'
